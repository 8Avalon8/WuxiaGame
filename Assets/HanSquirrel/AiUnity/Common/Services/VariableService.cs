...
namespace AiUnity.Common.Services
{
    ...
    /// </summary>
    /// <seealso cref="AiUnity.Common.Patterns.AISingleton{AiUnity.ScriptBuilder.Editor.Services.VariableService}" />
    public class VariableService : AISingleton<VariableService>
    {
#region Properties
