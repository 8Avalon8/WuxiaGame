...
public class AssetTool : Editor
{
    ...
    {
        HSPackToolRaw.LZMARaw("Assets/Resources/TextAssets/values.bytes", "Assets/StreamingAssets/values.zip");
        HSPackToolRaw.LZMARaw("Assets/Resources/TextAssets/tilemaps.bytes", "Assets/StreamingAssets/tilemaps.zip");
        AssetDatabase.Refresh();
    }
