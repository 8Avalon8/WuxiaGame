...
namespace HSUI.Demo
{
    ...
    public class DemoWidgetSidebar : MonoBehaviour, IHSUIComponent
    {
        ...
        Toggle CreateToggle()
        {
            GameObject obj = null;
#if UNITY_EDITOR
            obj = UnityEditor.AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Prefabs/BaseSideBarToggle.prefab");
#endif
        ...
        Button CreateButton()
        {
            GameObject obj = null;
#if UNITY_EDITOR
            obj = UnityEditor.AssetDatabase.LoadAssetAtPath<GameObject>("Assets/Prefabs/BaseSideBarButton.prefab");
#endif
